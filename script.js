...
const products = [
    { id: 'p1', name: '화분', emoji: '<img src="pot.png" style="width: 1em; height: 1em; text-align: center; vertical-align: middle; border-radius: 10%;">', price: 2000 },
    { id: 'p2', name: '장미다발', emoji: '🌹', price: 2000 },
    { id: 'p3', name: '해바라기', emoji: '🌻', price: 2000 },
    { id: 'p4', name: '부케꽃', emoji: '💐', price: 2000 },
    { id: 'p5', name: '캐모마일', emoji: '🌼', price: 2000 },
    { id: 'p6', name: '수국', emoji: '<img src="hydrangea.png" style="width: 1em; height: 1em; text-align: center; vertical-align: middle; border-radius: 10%;">', price: 2000 }
];
